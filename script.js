...
// eventlistener for search button
    ...
    function load(){
        var onload = pastCities[0]
        console.log(onload)
                // This is our API key. Add your own API key between the ""
        var APIKey = "115202e2247bd2aae5e7bd324023eefd";
    
        // Here we are building the URL we need to query the database
        var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + onload + "&appid=" + APIKey;
...
// function to search when button it clicked
    $("button").on("click", function(){
        ...
        // Here we are building the URL we need to query the database
        var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + x + "&appid=" + APIKey;
        // ca;; the api to get information
        $.ajax({
            url: queryURL,
            mathod: "GET"
